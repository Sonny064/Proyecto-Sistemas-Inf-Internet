...
public class Proyecto implements Serializable {
    ...
    public List<Ingresos_Egresos> getListaIngresos() {
        return listaIngresos;
    }

    public void setListaIngresos(List<Ingresos_Egresos> listaIngresos) {
        this.listaIngresos = listaIngresos;
    }

    public List<Personal_Asociacion> getPersonalProyecto() {
        return personalProyecto;
    }

    public void setPersonalProyecto(List<Personal_Asociacion> personalProyecto) {
